  ...
  return (
    <div className="container mx-auto px-4 py-16 space-y-8">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        {/* Profile section */}
        <section className="border-2 border-gray-300 p-6 rounded-lg">
        ...
        {/* Showcased Works */}
        <section className="border-2 border-gray-300 p-6 rounded-lg flex-1">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <section className="border-2 border-gray-300 p-6 rounded-lg order-2 md:order-1">
        ...
        <section className="border-2 border-gray-300 p-6 rounded-lg flex-1 order-1 md:order-2">
