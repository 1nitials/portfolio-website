      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 font-bold font-jura">
            ...
            <br/> All of the games here were made during 2025.
          </p>
        </div>

        {/* Game Cards */}
        <div className="flex gap-2 sm:gap-4 md:gap-8 justify-center items-center">
          ...
          <Tooltip title="Rhythm minigame made for the Solo Dev Game Jam" placement="bottom" arrow>
            <a href="https://1nitials.itch.io/slap-chop" target="_blank" rel="noopener noreferrer">
              <div className="border-2 border-black rounded-2xl overflow-hidden w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 hover:scale-105 transition-transform cursor-pointer">
                <Image
                  src={slapchop}
